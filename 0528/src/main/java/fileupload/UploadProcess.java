...
public class UploadProcess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			String saveDirectory = getServletContext().getRealPath("C:\\Users\\Manic-063\\git\\jsp\\0528\\src\\main\\webapp\\Uploads");
			String uploadDirectory = getServletContext().getRealPath("/13FileUpload");
			System.out.println("업로드 디렉터리 경로: " + uploadDirectory);
